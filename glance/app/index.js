...
function onTick(now) {
	...
	if (battery.charging) compl_battery.style.display = 'none';
	else if (battery.chargeLevel > 25) {
		battery_percent.style.fill = 'fb-mint';
		battery_gauge_fg.style.fill = 'fb-mint';
		battery_gauge_bg.style.fill = 'fb-green-press';
		compl_battery.style.display = 'inline';
	} else if (battery.chargeLevel > 16) {
		battery_percent.style.fill = 'fb-peach';
		battery_gauge_fg.style.fill = 'fb-peach';
		battery_gauge_bg.style.fill = '#8B4513';
		compl_battery.style.display = 'inline';
	} else {
